...
public class PuzzleManagerTest_GoodScenario {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "test1.in", "test1.testOut" }, { "test2.in", "test2.testOut" },
				{ "test9.in", "test9.testOut" }, { "test10.in", "test10.testOut" }, { "test11.in", "test11.testOut" },
				{ "test12.in", "test12.testOut" }, { "test13.in", "test13.testOut" }, { "test14.in", "test14.testOut" },
				{ "test15.in", "test15.testOut" }, { "test16.in", "test16.testOut" },
